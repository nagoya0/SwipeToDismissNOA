...
public class SwipeDismissTouchListener implements View.OnTouchListener {
	...
	// Percentage of the View Width that must be swiped before dismiss can happen
	private static final float SWIPE_SENSITIVITY = 0.92f;
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    ...
                    setAlpha(mView, Math.max(0f, Math.min(1f,
                             1f - Math.abs(deltaX) / SWIPE_SENSITIVITY * mViewWidth)));
                    return true;
                }
                break;
            }
